...
public class MeshGenerator : MonoBehaviour
{
    ...
    public class SquareGrid
    {
        ...
        public SquareGrid(int[,] map, float squareSize)
        {
            ...
            for (int x = 0; x < nodeCountX; x++)
            {
                ...
                {
                    Vector3 pos = new Vector3((-mapWidth / 2) + (x * squareSize) + (squareSize / 2), 0, (-mapHeight / 2) + (y * squareSize) + (squareSize / 2)); //check triple
    ...
    public class Square
    {
        ...
        public Square (ControlNode _topLeft, ControlNode _topRight, ControlNode _bottomLeft, ControlNode _bottonRight)
        {
            topLeft = _topLeft;
            topRight = _topRight;
            bottomLeft = _bottomLeft;
            bottomRight = _bottonRight;
